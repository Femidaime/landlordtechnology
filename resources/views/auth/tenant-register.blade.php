...
@section('content')
<div class="login-page cnt-bg-photo overview-bgi" style="background-image: url({{url('/landing/img/landlord-tech-image-19.png')}})">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
              <div class="content-form-box register-box">
                  <div class="login-header"><h4>Sign Up As a Tenant</h4></div>
            ...
            <div class="col-lg-6 LT-info">
              ...
              <div class="register-info">
                ...
                <p>Sign Up as a Tenant on LandLords Technology and get your preferred living Space</p>
                <a data-animation="animated fadeInUp delay-12s" href="{{url('/register')}}" class="btn btn-lg btn-round btn-white-lg-outline">Landlord Sign Up</a>
                <a data-animation="animated fadeInUp delay-12s" href="{{url('/register')}}"  class="btn btn-lg btn-round btn-white-lg-outline">Agent Sign Up</a>
              </div>
            </div>
        </div>
    </div>
