        ...
        <div class="row">
            <div class="col-lg-6">
              <div class="content-form-box register-box">
                  <div class="login-header"><h4> Tenants Login</h4></div>
                  <form method="POST" action="{{ route('login') }}">
                      ...
                      <div class="login-footer text-center">
                          <p>Don't have an account yet?<a href="{{url('/tenant-register')}}"> Go Back </a></p>
            ...
            <div class="col-lg-6 LT-info">
              ...
              <div class="register-info">
                ...
                <p> Sign Into LandLords Technology and view your Tenants Profile Account information </p>
              </div>
            </div>
        </div>
    </div>
