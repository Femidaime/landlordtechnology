    ...
    <div class="content-header row">
      <div class="col-12">
        ...
        <div class="content-body">
          ...
          <section id="image-gallery " style="width: 100%;" class="card">
          ...
          <div class="card-content">
            <div class="card-body">
             <form method="get" action="{{url('/landlord/view-agreements')}}" style="display:block">
            ...
            <div class="card-body col-md-12 my-gallery" itemscope itemtype="{{url('//schema.org/ImageGallery')}}">
              <div class="row">
              @if(count($getAgreement) > 0)    
               @foreach($getAgreement as $agreement)   
                <div class="col-lg-3 col-md-6 col-12" itemprop="associatedMedia" itemscope itemtype="{{url('//schema.org/ImageObject')}}">
                  <a href="{{asset('storage')}}/{{$agreement->name}}" itemprop="contentUrl" target="_blank" data-size="480x360">
                    <div class="otherImage"> 
                     <img src="/storage/{{$agreement->name}}"
